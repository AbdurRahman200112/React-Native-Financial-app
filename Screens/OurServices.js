...
import { View, Image, Text, ScrollView, Dimensions, SafeAreaView,TouchableOpacity } from 'react-native';
...
const AvailableServices = ({ navigation }) => {
  return (
    <SafeAreaView style={{backgroundColor:'white'}}>
     ...
     <TouchableOpacity onPress={() => navigation.navigate('CALCULATOR')}><View style={{height: 335, width: 320, borderRadius: 20, padding: 20, marginBottom: 10 }} className="bg-slate-100">
      ...
      <TouchableOpacity><View style={{height: 335, width: 320, borderRadius: 20, padding: 20, marginBottom: 10 }}
      ...
      <TouchableOpacity><View style={{height: 335, width: 320, borderRadius: 20, padding: 20, marginBottom: 10 }} className="bg-slate-100">
      ...
      <TouchableOpacity><View style={{height: 335, width: 320, borderRadius: 20, padding: 20 }} className="bg-slate-100 ">
      ...
      <TouchableOpacity><View style={{height: 335, width: 320, borderRadius: 20, padding: 20,marginTop:10 }} className="bg-slate-100 ">
      ...
      <TouchableOpacity><View style={{height: 335, width: 320, borderRadius: 20, padding: 20, marginTop:10 }} className="bg-slate-100 mb-10">
